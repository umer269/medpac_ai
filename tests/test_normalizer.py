...
class TestNyulUdupaNormalizer:
    ...
    def test_save_and_load_roundtrip(self, tmp_path):
        ...
        np.testing.assert_array_almost_equal(norm.standard_scale, loaded.standard_scale, decimal=6)
    ...
    def test_fit_transform_convenience(self):
        ...
        assert all(r.shape == v.shape for r, v in zip(results, vols, strict=False))
