...
class TransformedSeries:
    ...
    preview_slice: np.ndarray | None = field(default=None, repr=False)
    segmentation_array: np.ndarray | None = field(default=None, repr=False)
    preview_slice_axis: int = field(default=0, repr=False)
    segmentation_volume_cc: float | None = field(default=None, repr=False)
