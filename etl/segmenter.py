...
class DicomSegmenter:
    ...
    def segment(
        self, volume: np.ndarray, modality: str, spacing: tuple[float, float, float]
    ...
    def _run_mock_segmentation(
        ...
        if ndimage is None:
            ...
            logger.warning(
                "scipy not available for morphological mock segmentation. Returning center sphere."
            )
            z, y, x = shape
        ...
        if modality == "MR":
            ...
            for z in range(z_start, z_end):
                ...
                seed[
                    z,
                    center_y - r_y : center_y + r_y,
                    center_x - r_x - int(r_x * 0.5) : center_x - int(r_x * 0.5),
                ] = True
                # Right horn
                seed[
                    z,
                    center_y - r_y : center_y + r_y,
                    center_x + int(r_x * 0.5) : center_x + r_x + int(r_x * 0.5),
                ] = True
